...
{
    public class CustomeDateTimePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        private Color skinColor = Helper.fadeColor;
        private Color textColor = Helper.viotlet;
